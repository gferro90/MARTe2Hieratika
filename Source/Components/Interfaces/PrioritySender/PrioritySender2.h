/**
 * @file PrioritySender2.h
 * @brief Header file for class PrioritySender2
 * @date 01 dic 2018
 * @author pc
 *
 ...
 * @details This header file contains the declaration of the class PrioritySender2
 ...
 */
class PrioritySender2: public MultiThreadService {
public:
     ...
     */
    friend void PrioritySenderCycleLoop(PrioritySender2 &arg);
...
private:
     ...
     */
    EmbeddedServiceMethodBinderT<PrioritySender2> embeddedMethod;
