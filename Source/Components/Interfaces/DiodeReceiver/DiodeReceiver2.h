/**
 * @file DiodeReceiver2.h
 * @brief Header file for class DiodeReceiver2
 * @date 04 dic 2018
 * @author pc
 *
 ...
 * @details This header file contains the declaration of the class DiodeReceiver2
...
class DiodeReceiver2: public MultiClientService {
public:
    CLASS_REGISTER_DECLARATION()
    DiodeReceiver2();
    virtual ~DiodeReceiver2();
    ...
    friend void DiodeReceiver2CycleLoop(DiodeReceiver2 &arg);
...
protected:
    ...
    EmbeddedServiceMethodBinderT<DiodeReceiver2> embeddedMethod;
