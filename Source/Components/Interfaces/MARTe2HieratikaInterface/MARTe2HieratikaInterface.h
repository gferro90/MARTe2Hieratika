...
public:
    ...
    virtual bool GetTid(const char8 *token,
                        BufferedStreamI &response);
    ...
    virtual bool GetPages(const char8 *token,
                          BufferedStreamI &response);
    ...
    virtual bool GetSchedules(const char8 *pageName,
                              const char8 *userName,
                              const char8 *token,
                              BufferedStreamI &response);
    ...
    virtual bool UpdateSchedule(const char8 *userName,
                                const char8* variables,
                                const char8 *token,
                                const char8 *tid,
                                const char8 *scheduleUID,
    ...
    virtual bool Commit(const char8 *userName,
                        const char8 *variables,
                        const char8 *token,
                        const char8 *tid,
                        const char8 *scheduleUID,
    ...
    virtual bool DeleteSchedule(const char8 *scheduleUID,
                                const char8 *token,
                                BufferedStreamI &response);

    virtual bool UpdatePlant(const char8 *pageName,
                             const char8* variables,
                             const char8 *token,
                             const char8* tid,
                             BufferedStreamI &response);
